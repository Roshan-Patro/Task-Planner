...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<CustomErrorDetails> methodArgumentNotValidExceptionHandler(
			MethodArgumentNotValidException e) {
		CustomErrorDetails err = new CustomErrorDetails(LocalDateTime.now(), "Validation Error!",
